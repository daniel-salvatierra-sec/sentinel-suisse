...
_ALIAS_TO_SLUG: dict[str, str] = {
    ...
    "other general jobs": "other",
    "domestic-help-cleaning-jobs": "cleaner",
    "domestic help cleaning jobs": "cleaner",
    "cleaning-jobs": "cleaner",
    "cleaning jobs": "cleaner",
...
_TITLE_TO_SLUG: tuple[tuple[str, str], ...] = (
    ...
    ("concierge d immeuble", "concierge"),
    ("agent de nettoyage", "cleaner"),
    ("agente de limpieza", "cleaner"),
    ("femme de menage", "cleaner"),
    ("homme toutes mains", "concierge"),
    ("gebaudereiniger", "cleaner"),
    ("gebaeudereiniger", "cleaner"),
    ("unterhaltsreinigung", "cleaner"),
    ("reinigungsfachkraft", "cleaner"),
    ...
    ("preparateur de commandes", "warehouse"),
    ("preparateur commandes", "warehouse"),
    ("kommissionier", "warehouse"),
    ("stockiste", "warehouse"),
    ("supply chain", "purchasing"),
    ("chaine logistique", "logistics"),
    ("approvisionnement", "purchasing"),
    ("acheteuse", "purchasing"),
    ("acheteur", "purchasing"),
    ("procurement", "purchasing"),
    ("einkaufer", "purchasing"),
    ("buyer", "purchasing"),
...
def classify_job_category(portal: str | None, title: str | None) -> str | None:
    ...
    if title_canon and title_canon != "other":
        ...
        if portal_canon == "construction":
            return title_canon
        if parent_field(title_canon) in {
            "it",
            "education",
            "healthcare",
            "admin",
