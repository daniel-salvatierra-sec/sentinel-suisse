...
const FAQ_ENTRIES: FaqEntry[] = [
  {
    ...
    answer: {
      fr: "Le bouton Compte est en haut à droite. Je t'y emmène. [[gesture:account]]",
      de: "Der Knopf Konto ist oben rechts. Ich führe dich dorthin. [[gesture:account]]",
      es: "El botón Cuenta está arriba a la derecha. Te llevo ahora. [[gesture:account]]",
      pt: "O botão Conta está no canto superior direito. Levo-te já. [[gesture:account]]",
  ...
  },
  {
    id: "who_are_you",
    match: {
      fr: [["qui es tu", "c est quoi sentinel", "c est quoi sentinela", "tu es qui", "tu es un robot", "tu es humain"]],
      de: [["wer bist du", "was ist sentinel", "was ist sentinela", "bist du ein roboter", "bist du ein mensch"]],
      es: [["quien eres", "que es sentinel", "que es sentinela", "eres un robot", "eres humano", "eres una persona"]],
      pt: [["quem es tu", "o que e o sentinel", "o que e a sentinela", "es um robo", "es humano"]],
      en: [["who are you", "what is sentinel", "what is sentinela", "are you a robot", "are you human"]],
    },
    answer: {
      fr: "Je suis Sentinela, l'assistante de LinkSwiss — un guide automatisé (pas un humain) là pour t'aider à trouver un logement ou un emploi, comprendre les alertes et Premium, et répondre à tes questions sur l'appli.",
      de: "Ich bin Sentinela, die Assistentin von LinkSwiss — ein automatisierter Guide (kein Mensch), der dir hilft, eine Wohnung oder einen Job zu finden, Alerts und Premium zu verstehen und deine Fragen zur App zu beantworten.",
      es: "Soy Sentinela, la asistente de LinkSwiss — una guía automatizada (no una persona) para ayudarte a encontrar vivienda o empleo, entender las alertas y Premium, y responder tus preguntas sobre la app.",
      pt: "Sou a Sentinela, a assistente do LinkSwiss — um guia automatizado (não uma pessoa) para te ajudar a encontrar casa ou emprego, entender os alertas e o Premium, e responder às tuas perguntas sobre a app.",
      en: "I'm Sentinela, LinkSwiss's assistant — an automated guide (not a human) here to help you find housing or a job, understand alerts and Premium, and answer your questions about the app.",
    },
  },
  {
    id: "greeting",
