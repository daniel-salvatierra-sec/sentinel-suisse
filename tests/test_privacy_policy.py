...
def test_privacy_policy_all_languages(client: TestClient, lang: str) -> None:
    response = client.get(f"/api/v1/legal/privacy?lang={lang}")
...
def test_privacy_policy_rejects_invalid_language(client: TestClient) -> None:
    response = client.get("/api/v1/legal/privacy?lang=it")
